      ...
      <div className={modalVariants.containerGradient}>
        <div className="relative max-w-[1166px] w-[96vw] overflow-hidden pt-14 pl-14 pb-14 pr-0">
          <button
            aria-label="Close"
            onClick={onClose}
            className="absolute right-4 top-4 inline-flex items-center justify-center rounded-[11px] border border-[rgba(0,229,255,0.99)] text-white bg-[rgba(2,255,251,0.07)] hover:bg-[rgba(2,255,251,0.35)] transition-all w-9 h-9"
          >
            <X className="w-5 h-5" />
          </button>

          {/* Arrows for carousel (optional) */}
          {canShowArrows && (
            <>
              <button
                aria-label="Previous"
                onClick={goPrev}
                className="absolute left-2 top-1/2 -translate-y-1/2 z-10 rounded-[11px] border border-[rgba(0,229,255,0.5)] text-white bg-[rgba(2,255,251,0.07)] hover:bg-[rgba(2,255,251,0.25)] px-3 py-2"
              >
                ←
              </button>
              <button
                aria-label="Next"
                onClick={goNext}
                className="absolute right-2 top-1/2 -translate-y-1/2 z-10 rounded-[11px] border border-[rgba(0,229,255,0.5)] text-white bg-[rgba(2,255,251,0.07)] hover:bg-[rgba(2,255,251,0.25)] px-3 py-2"
              >
                →
              </button>
            </>
